import './About.css'
// import imgAbout from '../../assets/Imagen.webp'
// import imgAbout from '../../assets/Meet-about.webp'
        ...
        <h2>¿Quiénes somos?</h2>
          <div className='about-col'>
              ...
              <div className='description'>
                ...
                {/* <button className='btn-about'>Contactanos</button> */}
                <ul className='ul-about'>
                    <li className='li-about'><FaCheckCircle className='icon-check' />Calidad</li>
                    <li className='li-about'><FaCheckCircle className='icon-check' />Compromiso</li>
                    <li className='li-about'><FaCheckCircle className='icon-check' />Responsabilidad</li>
                </ul>
              </div>
